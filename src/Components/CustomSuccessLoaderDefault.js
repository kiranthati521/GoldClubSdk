...
const CustomSuccessLoaderDefault = props => {
  const {
    loading,
    message,
    ...attributes
  ...
  return (
    <Modal
      ...
      <View style={[styles['justify_content_center'],{ backgroundColor: "#000000d6", position: "absolute", top: 0, bottom: 0, left: 0, right: 0, alignItems: "center"}]}>
        <Image source={require("../assets/images/success.gif")} style={[styles['justify_content_center'],styles['align_self_center'],styles['center_align_items'],{ width: 150, height: 150 }]} resizeMode={'contain'} />
...
export default CustomSuccessLoaderDefault;
