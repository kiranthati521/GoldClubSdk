...
export const createStyles = () =>
  StyleSheet.create({
    ...
    'font_size_9.5_regular': {
        fontSize: 9.5,
        fontFamily: FontForWeight('regular')
    },
    'font_size_9.5_semibold': {
        fontSize: 9.5,
        fontFamily: FontForWeight('SemiBold')
    },
    'font_size_9.5_bold': {
    ...
    'font_size_15_regular': {
        fontSize: 15,
        fontFamily: FontForWeight('regular')
    },
    'font_size_15_semibold': {
        fontSize: 15,
        fontFamily: FontForWeight('SemiBold')
    },
    'font_size_15_bold': {
    ...
    'font_size_30_bold': {
      ...
      'font_size_30_semibold': {
          fontSize: 30,
          fontFamily: FontForWeight('SemiBold')
      },
      'font_size_20_semibold': {
          fontSize: 20,
          fontFamily: FontForWeight('SemiBold')
      },
     'font_size_40_semibold': {
          fontSize: 40,
          fontFamily: FontForWeight('SemiBold')
      },
      'font_size_20_bold': {
